...
import salesplatform.service.LbService;
...
/*	@RequestMapping(value="/get-product-lb")
	public ModelAndView GetProductLb(@RequestParam("id") String id){
		ModelAndView model = new ModelAndView();
		Map map = lbService.getProductLb(id);
