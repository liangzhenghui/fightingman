...
public class RedisTest {
     ...
     public void setUp() {
    	 ...
    	 //线程安全
    	 if(jedis==null){
    		 System.out.println("test jedis static");
	...
	//@Test
	public void testJedisTransaction() throws InterruptedException, ExecutionException{
		 final String key = "test-cas-1";
	     int total=5;
	...
	public void testExpire(){
		jedis.setex("hello", 1, "helloValue");
		try {
			Thread.sleep(2000);
			String value=jedis.get("hello");
			System.out.println("expire value="+value);
